...
<html>
	...
	<link rel="stylesheet" href="js/jquery-ui-1.12.0/jquery-ui.min.css"></script>
	...
	<body>
		...
		<p>
			<input id="gravar" class="w3-btn" value="GRAVAR LIVRO">
			<br><br>
			<a class="w3-btn" href="livrinconsulta">CONSULTA</a>
		</p>
